...
public class Main {
    ...
    /* Chave e valor configurado no running da main -> Ordenados por ';'
    ...
    private static void startGame(Map<String, String> positions) {
        ...
        for (int i = 0; i < BOARD_LIMIT; i++) {
            ...
            for (int j = 0; j < BOARD_LIMIT; j++) {
                var positionConfig = positions.get("%s,%s".formatted(i, j)); // Pega apenas os valores configurado no running da main
    ...
    private static int runUntilGetValidNumber(final int min, final int max) {
        // Função para verificar se o valor informado para implementar na board é válido.
